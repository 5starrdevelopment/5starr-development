      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{
          ...
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, color: "#C8CCD8", lineHeight: 1.8, fontStyle: "italic", margin: 0 }}>
            Player Identity Cards are not for sale. They are earned through the work.
          </p>
        </div>

        {/* Single earned card */}
        <div style={{ ...cardStyle, padding: 40, textAlign: "center", maxWidth: 600, margin: "0 auto 48px" }}>
          <div style={goldTopBar} />
          ...
          <p style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 14, color: "#C8CCD8", lineHeight: 1.8, margin: "0 0 24px" }}>
            Train with 5-Starr Development for one year and your custom Player Identity Card is designed by Coach Starr personally — showcasing your stats, skills, position, and a personal scouting report. This isn't a product. It's a milestone.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 10, textAlign: "left", maxWidth: 360, margin: "0 auto 24px" }}>
          ...
          <GoldButton onClick={() => setPage("Book Now")}>Start Your Year</GoldButton>
        </div>
