    ...
    <>
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{ marginBottom: 60 }}>
          ...
          {/* Sample Game Plan Preview */}
          <div style={{ marginBottom: 40 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
              <h4 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 13, letterSpacing: 3, color: "#D4A843" }}>SAMPLE GAME PLAN</h4>
              <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 10, letterSpacing: 2, color: "#5A5F73", background: "rgba(212,168,67,0.1)", padding: "4px 12px", borderRadius: 4 }}>NAMES ANONYMIZED</span>
            </div>

            <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(212,168,67,0.1)", borderRadius: 8, overflow: "hidden" }}>
              {/* Report header */}
              <div style={{ background: "rgba(212,168,67,0.08)", padding: "20px 24px", borderBottom: "1px solid rgba(212,168,67,0.1)", textAlign: "center" }}>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 10, letterSpacing: 3, color: "#D4A843", marginBottom: 4 }}>COURTSIDE ANALYTICS</div>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 20, color: "#FFF", letterSpacing: 2 }}>GAME PLAN: NORTHSIDE PANTHERS</div>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 13, color: "#8A8FA3", fontStyle: "italic", marginTop: 4 }}>23-3 • #1 Ranked • Defending State Champions</div>
              </div>

              {/* Core insight callout */}
              <div style={{ background: "rgba(212,168,67,0.04)", borderLeft: "3px solid #D4A843", margin: "16px", padding: "14px 18px", borderRadius: "0 6px 6px 0" }}>
                <p style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 12, color: "#C8CCD8", lineHeight: 1.7, margin: 0 }}>
                  <strong style={{ color: "#FFF" }}>THE GAME WAS TIED AT 42.</strong> You didn't lose to a better team — you lost to fatigue. Your starters played 87% of available minutes. The fix: <strong style={{ color: "#D4A843" }}>single-sub rotations.</strong>
                </p>
              </div>

              {/* Quarter breakdown mini table */}
              <div style={{ padding: "0 16px 16px" }}>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 10, letterSpacing: 2, color: "#D4A843", marginBottom: 8, marginTop: 8 }}>QUARTER-BY-QUARTER</div>
                <div style={{ overflowX: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11 }}>
                    <thead>
                      <tr>
                        {["QTR", "Score", "+/-", "eFG%", "PPP"].map(h => (
                          <th key={h} style={{ fontFamily: "'Oswald', sans-serif", fontSize: 9, letterSpacing: 1, color: "#FFF", background: "rgba(212,168,67,0.12)", padding: "6px 10px", textAlign: "left", textTransform: "uppercase" }}>{h}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        { q: "Q1", s: "26-23", pm: "+3", efg: "70.6%", ppp: "1.53", good: true },
                        { q: "Q2", s: "9-16", pm: "-7", efg: "18.8%", ppp: "0.52", good: false },
                        { q: "Q3", s: "13-22", pm: "-9", efg: "28.6%", ppp: "0.67", good: false },
                        { q: "Q4", s: "12-20", pm: "-8", efg: "26.1%", ppp: "0.63", good: false },
                      ].map((r, i) => (
                        <tr key={i}>
                          <td style={{ fontFamily: "'Oswald', sans-serif", padding: "5px 10px", color: r.good ? "#81C784" : "#E57373", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{r.q}</td>
                          <td style={{ fontFamily: "'Oswald', sans-serif", padding: "5px 10px", color: r.good ? "#81C784" : "#E57373", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{r.s}</td>
                          <td style={{ fontFamily: "'Oswald', sans-serif", padding: "5px 10px", color: r.good ? "#81C784" : "#E57373", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{r.pm}</td>
                          <td style={{ fontFamily: "'Oswald', sans-serif", padding: "5px 10px", color: "#C8CCD8", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{r.efg}</td>
                          <td style={{ fontFamily: "'Oswald', sans-serif", padding: "5px 10px", color: "#C8CCD8", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{r.ppp}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              {/* Key finding */}
              <div style={{ background: "rgba(212,168,67,0.04)", borderLeft: "3px solid #D4A843", margin: "0 16px 16px", padding: "12px 16px", borderRadius: "0 6px 6px 0" }}>
                <p style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 11, color: "#C8CCD8", lineHeight: 1.6, margin: 0 }}>
                  <strong style={{ color: "#FFF" }}>#23 Thompson was your best player:</strong> 17 pts, 8/17, -1 +/-, 0 turnovers in 24 min. He played the <strong style={{ color: "#D4A843" }}>fewest starter minutes</strong> and was the freshest. That's not a coincidence.
                </p>
              </div>

              {/* Lineup insight */}
              <div style={{ padding: "0 16px" }}>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 10, letterSpacing: 2, color: "#D4A843", marginBottom: 8 }}>LINEUP ANALYSIS</div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16 }}>
                  <div style={{ background: "rgba(129,199,132,0.08)", border: "1px solid rgba(129,199,132,0.15)", borderRadius: 6, padding: 12, textAlign: "center" }}>
                    <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 18, color: "#81C784", fontWeight: 600 }}>-1</div>
                    <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 9, color: "#8A8FA3", letterSpacing: 1, marginTop: 2 }}>ALL 5 STARTERS • 21 MIN</div>
                  </div>
                  <div style={{ background: "rgba(229,115,115,0.08)", border: "1px solid rgba(229,115,115,0.15)", borderRadius: 6, padding: 12, textAlign: "center" }}>
                    <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 18, color: "#E57373", fontWeight: 600 }}>-21</div>
                    <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 9, color: "#8A8FA3", letterSpacing: 1, marginTop: 2 }}>2+ BENCH PLAYERS • 7 MIN</div>
                  </div>
                </div>
              </div>
              ...
              <div style={{ padding: "0 16px 20px" }}>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 10, letterSpacing: 2, color: "#D4A843", marginBottom: 8 }}>KEYS TO VICTORY</div>
                {[
                  "Single-sub only — always 4 starters on the floor",
                  "Sub Carter and Davis BEFORE they're tired",
                  "The 4:00 mark of Q3 is your moment of truth",
                  "Attack the paint — stop settling for threes",
                ].map((k, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 6 }}>
                    <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#D4A843", fontWeight: 700, minWidth: 20 }}>{i + 1}</span>
                    <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#C8CCD8", letterSpacing: 0.5 }}>{k}</span>
                  </div>
                ))}
              </div>
              ...
              <div style={{ background: "rgba(212,168,67,0.06)", padding: "16px 24px", borderTop: "1px solid rgba(212,168,67,0.1)", textAlign: "center" }}>
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 14, color: "#C8CCD8", fontStyle: "italic", lineHeight: 1.7, margin: 0 }}>
                  "The game was tied at 42. You proved you can play with the #1 team in the state for 24 minutes. The only question is whether you can do it for 32."
                </p>
              </div>
            </div>
          </div>
    ...
    <>
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24, marginBottom: 48 }}>
          ...
          <div style={{ ...cardStyle, padding: 32, textAlign: "center" }}>
            <div style={goldTopBar} />
            <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 48, fontWeight: 700, color: "#D4A843", marginBottom: 4 }}>$25</div>
            <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, letterSpacing: 2, color: "#8A8FA3", marginBottom: 16 }}>À LA CARTE</div>
            <div style={{ width: 40, height: 2, background: "#D4A843", margin: "0 auto 16px" }} />
            <p style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 13, color: "#C8CCD8", lineHeight: 1.7, margin: "0 0 20px" }}>
              Don't train with us yet? No problem. Any player can order a custom Player Identity Card for $25. Send us your stats, a photo, and your info — we'll design it and deliver within 48 hours.
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: 8, textAlign: "left", marginBottom: 20 }}>
