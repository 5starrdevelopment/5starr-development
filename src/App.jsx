...
// ─── Navigation ───
const NAV_ITEMS = ["Home", "About", "Services", "Membership", "Camps", "Free Resources", "Accessibility", "Book Now"];
  ...
  <section style={{
    ...
    <div style={{ textAlign: "center", position: "relative", zIndex: 1, padding: "120px 24px 80px" }}>
      ...
      <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", animation: "fadeInUp 1s ease 0.8s both" }}>
        ...
        <button onClick={() => setPage("Membership")} style={{ background: "transparent", border: "1px solid rgba(212,168,67,0.4)", padding: "14px 36px", color: "#D4A843", fontFamily: "'Oswald', sans-serif", fontSize: 15, fontWeight: 400, letterSpacing: 2, cursor: "pointer", borderRadius: 4, textTransform: "uppercase" }}>View Membership</button>
      </div>
    </div>
  </section>
);
...
const ServicesPage = ({ setPage }) => {
  const training = [
    ...
    {
      title: "OPEN GYM SHOOT-AROUND",
      desc: "Drop in and get shots up on the side goals while a 5-Starr session is in progress. A low-cost way to get extra reps in a real gym environment.",
      features: ["Side goal access", "Self-directed shooting", "Free for all members"],
      price: "$10 per player",
      note: "Free for Rising Starr, All-Starr & 5-Starr Elite members",
      examples: "Drop in · Get shots up · Get better",
    },
  ];

  const consulting = [
    { title: "SCOUTING REPORTS", price: "$100", desc: "Comprehensive opponent breakdowns with tendencies, key players, and strategic recommendations." },
    { title: "LINEUP ANALYSIS", price: "$100", desc: "Data-driven lineup evaluation and optimization. Free for All-Starr members and above.", free: "Free for All-Starr+" },
    { title: "PRACTICE PLAN DESIGN", price: "$100 – $250", desc: "Custom practice plans built on Constraints-Led Approach methodology tailored to your team's needs." },
    { title: "SCHEME CONSULTING", price: "$500 – $1,000", desc: "Offensive and defensive scheme design and implementation consulting for your program." },
    { title: "PROGRAM BUILDING", price: "$1,000 – $2,500", desc: "Full program consulting: culture, systems, player development structure, and identity building." },
    { title: "ANALYTICS DASHBOARD", price: "$200 setup + $50/mo", desc: "Custom team analytics dashboard with ongoing data updates and support." },
  ];
    ...
    <>
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{
          ...
          <h4 style={{ ...headingFont(14), marginBottom: 8 }}>ONLINE COACHING</h4>
          <p style={{ ...bodyFont, fontSize: 14, margin: 0 }}>
            Online coaching features — including custom workout programs, video breakdowns, direct messaging, and live virtual sessions — are <span style={{ color: "#D4A843" }}>included with membership tiers</span>.{" "}
            <span style={{ cursor: "pointer", color: "#F0D78C", textDecoration: "underline" }} onClick={() => setPage("Membership")}>View membership plans →</span>
          </p>
        </div>

        {/* Consulting */}
        <h3 style={{ ...headingFont(16), marginBottom: 24, letterSpacing: 4, color: "#8A8FA3" }}>COACHING CONSULTING</h3>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20, marginBottom: 48 }}>
          {consulting.map((c, i) => (
            <div key={i} style={{ ...cardStyle, padding: 24 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12, flexWrap: "wrap", gap: 8 }}>
                <h4 style={{ ...headingFont(15), letterSpacing: 1.5 }}>{c.title}</h4>
                <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 13, color: "#D4A843", letterSpacing: 0.5, whiteSpace: "nowrap" }}>{c.price}</span>
              </div>
              <p style={{ ...bodyFont, fontSize: 13, margin: 0 }}>{c.desc}</p>
              {c.free && <div style={{ ...tagStyle, marginTop: 12 }}>{c.free}</div>}
            </div>
          ))}
        </div>

        {/* Courtside Analytics */}
        <div style={{ marginBottom: 60, marginTop: 12 }}>
          ...
          <div style={{
            ...
            padding: "20px 24px", borderRadius: "0 8px 8px 0", marginBottom: 24,
          }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {[
              { title: "SCOUTING REPORT", price: "$100", desc: "Opponent breakdown: identity, key players, tendencies, lineup data, loss patterns, and vulnerabilities." },
              { title: "GAME PLAN", price: "$100–$150", desc: "Opponent-specific rotation plan with minute targets, keys to victory, bench reference card, and Game 1 autopsy if rematch." },
              { title: "GAME DAY BUNDLE", price: "$175–$250", desc: "Scouting Report + Game Plan + 1-page printable bench card. Everything you need for game day." },
              { title: "POST-GAME AUTOPSY", price: "$100", desc: "Quarter-by-quarter analysis, player performance vs expectations, lineup effectiveness, and actionable takeaways." },
              { title: "SEASON PACKAGE", price: "$400–$600/mo", desc: "Weekly game plans, opponent scouting, in-form analysis, season trends, and player development profiles." },
              { title: "PROGRAM PACKAGE", price: "$750–$1,000/mo", desc: "Everything in Season + offseason analytics, practice design recommendations, and recruiting profiles." },
            ].map((p, i) => (
              <div key={i} style={{ ...cardStyle, padding: 24 }}>
                <div style={goldTopBar} />
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12, flexWrap: "wrap", gap: 8 }}>
  ...
  const tiers = [
    {
      ...
      color: "#8A8FA3",
      rates: { solo: "$1.13/min", group: "$0.45/min", save: "10%" },
      perks: [
        "10% off per-minute training rates",
    ...
    },
    {
      ...
      color: "#D4A843",
      featured: true,
      rates: { solo: "$1.00/min", group: "$0.40/min", save: "20%" },
      perks: [
        "20% off per-minute training rates",
        "Everything in Rising Starr",
        "Custom workout & drill programs",
        "Direct messaging access to Coach Starr",
        "Free lineup analysis (normally $50-$100)",
        "Priority scheduling",
      ],
    },
    {
      ...
      color: "#F0D78C",
      rates: { solo: "$0.88/min", group: "$0.35/min", save: "30%" },
      perks: [
        "30% off per-minute training rates",
        "Everything in All-Starr",
        "Monthly video breakdown of your film",
        "1 live virtual training session per month",
        "Monthly progress report with analytics",
        "Free camp & clinic registration",
      ],
    },
  ];
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24, marginBottom: 48 }}>
          {tiers.map((t, i) => (
            <div key={i} style={{
              ...cardStyle,
              border: t.featured ? "1px solid rgba(212,168,67,0.4)" : cardStyle.border,
              display: "flex", flexDirection: "column",
            }}>
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: t.featured ? "#D4A843" : "linear-gradient(90deg, transparent, rgba(212,168,67,0.3), transparent)" }} />

              {t.featured && (
                <div style={{ ...tagStyle, marginBottom: 16, alignSelf: "flex-start" }}>MOST POPULAR</div>
              )}

              <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 24, color: t.color, letterSpacing: 3, margin: "0 0 4px" }}>{t.name}</h3>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 14, color: "#5A5F73", fontStyle: "italic", margin: "0 0 20px" }}>{t.tagline}</p>

              <div style={{ marginBottom: 20 }}>
                <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 42, fontWeight: 700, color: "#FFFFFF" }}>{t.price}</span>
                <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#5A5F73", letterSpacing: 1 }}> /month</span>
              </div>

              <div style={{ background: "rgba(212,168,67,0.06)", borderRadius: 6, padding: "14px 16px", marginBottom: 20 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#8A8FA3", letterSpacing: 1 }}>1-ON-1</span>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#D4A843" }}>{t.rates.solo}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#8A8FA3", letterSpacing: 1 }}>GROUP</span>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#D4A843" }}>{t.rates.group}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <span style={{ ...tagStyle, fontSize: 9 }}>SAVE {t.rates.save}</span>
                </div>
              </div>
              ...
              <div style={{ flex: 1, marginBottom: 24 }}>
                {t.perks.map((p, j) => (
                  <div key={j} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10 }}>
                    <StarAccent />
                    <span style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 13, color: "#C8CCD8", lineHeight: 1.6 }}>{p}</span>
                  </div>
                ))}
              </div>

              <GoldButton onClick={() => setPage("Book Now")} full>Join {t.name.split(" ").pop()}</GoldButton>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          padding: "28px 32px", textAlign: "center", marginBottom: 48,
        }}>
          <h4 style={{ ...headingFont(16), marginBottom: 8 }}>LOYALTY PROGRAM — STACKS WITH MEMBERSHIP</h4>
          <p style={{ ...bodyFont, fontSize: 14, margin: 0 }}>
            Every member earns a <span style={{ color: "#D4A843" }}>free session after every 10 paid sessions</span>. The free session length equals the average of your 10 sessions. The more you train, the more you earn.
          </p>
        </div>

        {/* Comparison table */}
        <h3 style={{ ...headingFont(16), marginBottom: 24, letterSpacing: 4, color: "#8A8FA3", textAlign: "center" }}>WHAT'S INCLUDED AT EACH LEVEL</h3>
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 600 }}>
            <thead>
              <tr>
                <th style={{ textAlign: "left", padding: "12px 16px", borderBottom: "1px solid rgba(212,168,67,0.2)", fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#5A5F73", letterSpacing: 2 }}>FEATURE</th>
                {["RISING STARR", "ALL-STARR", "5-STARR ELITE"].map(t => (
                  <th key={t} style={{ textAlign: "center", padding: "12px 16px", borderBottom: "1px solid rgba(212,168,67,0.2)", fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#D4A843", letterSpacing: 1.5 }}>{t}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {[
                { feature: "Discounted training rates", r: "10%", a: "20%", e: "30%" },
                { feature: "Free shoot-around access", r: "✓", a: "✓", e: "✓" },
                { feature: "Video library access", r: "✓", a: "✓", e: "✓" },
                { feature: "Community group chat", r: "✓", a: "✓", e: "✓" },
                { feature: "Custom workout programs", r: "—", a: "✓", e: "✓" },
                { feature: "Direct messaging", r: "—", a: "✓", e: "✓" },
                { feature: "Priority scheduling", r: "—", a: "✓", e: "✓" },
                { feature: "Free lineup analysis", r: "—", a: "✓", e: "✓" },
                { feature: "Saturday booking access", r: "—", a: "✓", e: "✓" },
                { feature: "Monthly film breakdown", r: "—", a: "—", e: "✓" },
                { feature: "Live virtual session (1/mo)", r: "—", a: "—", e: "✓" },
                { feature: "Monthly analytics report", r: "—", a: "—", e: "✓" },
                { feature: "Free camp registration", r: "—", a: "—", e: "✓" },
                { feature: "Sunday booking (by request)", r: "—", a: "—", e: "✓" },
              ].map((row, i) => (
                <tr key={i}>
                  <td style={{ padding: "10px 16px", borderBottom: "1px solid rgba(255,255,255,0.04)", fontFamily: "'Libre Baskerville', serif", fontSize: 13, color: "#C8CCD8" }}>{row.feature}</td>
                  {[row.r, row.a, row.e].map((v, j) => (
                    <td key={j} style={{ textAlign: "center", padding: "10px 16px", borderBottom: "1px solid rgba(255,255,255,0.04)", fontFamily: "'Oswald', sans-serif", fontSize: 14, color: v === "—" ? "#3A3F53" : v === "✓" ? "#D4A843" : "#F0D78C" }}>{v}</td>
                  ))}
                </tr>
              ))}
            </tbody>
...
const CampsPage = ({ setPage }) => {
  const camps = [
    { title: "SHOT DOCTOR CLINIC", date: "Summer 2026", ages: "Grades 6-12", duration: "Full Day", price: "$125", desc: "Intensive shooting mechanics clinic. Break down, rebuild, and refine your shot with analytics-backed coaching." },
    { title: "ELITE SKILLS CAMP", date: "Summer 2026", ages: "Grades 8-12", duration: "3 Days", price: "$400", desc: "Three-day camp focused on complete offensive development: shooting, ball handling, footwork, and live-action play." },
    { title: "YOUTH DEVELOPMENT CAMP", date: "Summer 2026", ages: "Grades 3-7", duration: "Full Day", price: "$85", desc: "Fun, fundamentals-focused camp designed to build a love for the game while developing core basketball skills." },
    { title: "COACHES CLINIC", date: "Fall 2026", ages: "All Coaches", duration: "Full Day", price: "$300", desc: "Learn how to integrate analytics, Constraints-Led Approach methodology, and development-first coaching into your program." },
  ];
  ...
  return (
    <>
      <div style={{ paddingTop: 80 }} />
      <Section bg="#0A0E1A">
        <SectionTitle pre="Events" title="CAMPS & CLINICS" sub="Have Fun. Get Better." />
        <div style={{
          background: "rgba(212,168,67,0.06)", border: "1px solid rgba(212,168,67,0.15)",
          borderRadius: 8, padding: "16px 24px", marginBottom: 40, textAlign: "center",
        }}>
          <p style={{ ...bodyFont, fontSize: 13, margin: 0 }}>
            <span style={{ color: "#D4A843" }}>5-Starr Elite members</span> receive free camp & clinic registration
          </p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
          {camps.map((c, i) => (
            <div key={i} style={{ ...cardStyle, display: "flex", flexDirection: "column" }}>
              <h3 style={{ ...headingFont(20), marginBottom: 16 }}>{c.title}</h3>
              <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
                <span style={tagStyle}>{c.date}</span>
                <span style={{ ...tagStyle, background: "rgba(255,255,255,0.05)", color: "#8A8FA3" }}>{c.ages}</span>
                <span style={{ ...tagStyle, background: "rgba(255,255,255,0.05)", color: "#8A8FA3" }}>{c.duration}</span>
              </div>
              <p style={{ ...bodyFont, margin: "0 0 20px", flex: 1 }}>{c.desc}</p>
              <div style={{ borderTop: "1px solid rgba(212,168,67,0.1)", paddingTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 28, fontWeight: 700, color: "#D4A843" }}>{c.price}</span>
                  <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: 12, color: "#5A5F73", letterSpacing: 1 }}> / {c.title === "COACHES CLINIC" ? "coach" : "player"}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div style={{ textAlign: "center", marginTop: 48 }}>
          <GoldButton onClick={() => setPage("Book Now")}>Register Now</GoldButton>
        </div>
      </Section>
    </>
  );
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24, marginBottom: 60 }}>
          {resources.map((r, i) => (
            <div key={i} style={{ ...cardStyle, display: "flex", flexDirection: "column" }}>
              <div style={goldTopBar} />
              <span style={tagStyle}>{r.type}</span>
              <h4 style={{ ...headingFont(18), margin: "16px 0 12px" }}>{r.title}</h4>
              <p style={{ ...bodyFont, fontSize: 13, margin: "0 0 20px", flex: 1 }}>{r.desc}</p>
              <button onClick={() => { if (!subscribed) { setSubscribed(true); } }} style={{
                background: "transparent", border: "1px solid rgba(212,168,67,0.4)",
                padding: "10px 24px", color: "#D4A843", fontFamily: "'Oswald', sans-serif",
                fontSize: 13, letterSpacing: 1.5, cursor: "pointer", borderRadius: 4, textTransform: "uppercase",
                width: "100%",
              }}>{r.cta}</button>
            </div>
          ))}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20, marginBottom: 48 }}>
          {videos.map((v, i) => (
            <div key={i} style={{
              ...
              <div style={{
                height: 140, background: "linear-gradient(135deg, rgba(212,168,67,0.08), rgba(17,24,51,0.9))",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
                <div style={{
                  width: 48, height: 48, borderRadius: "50%", background: "rgba(212,168,67,0.2)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  border: "2px solid rgba(212,168,67,0.4)",
                }}>
                  <span style={{ color: "#D4A843", fontSize: 18, marginLeft: 3 }}>▶</span>
                </div>
              </div>
              <div style={{ padding: "16px 20px" }}>
                <span style={{ ...tagStyle, fontSize: 9, marginBottom: 8, display: "inline-block" }}>{v.category}</span>
                <h4 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 15, color: "#C8CCD8", letterSpacing: 1, margin: 0 }}>{v.title}</h4>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          textAlign: "center", padding: 32, borderRadius: 8,
          background: "rgba(212,168,67,0.04)", border: "1px solid rgba(212,168,67,0.1)", marginBottom: 48,
        }}>
          <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#8A8FA3", letterSpacing: 2, margin: "0 0 8px", textTransform: "uppercase" }}>Coming Soon</p>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, color: "#F0D78C", fontStyle: "italic", margin: 0 }}>Full video library with subscriber access launching 2026</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <button onClick={() => setPage("Camps")} style={{
              background: "transparent", border: "1px solid rgba(212,168,67,0.4)",
              padding: "10px 20px", color: "#D4A843", fontFamily: "'Oswald', sans-serif",
              fontSize: 12, letterSpacing: 1.5, cursor: "pointer", borderRadius: 4, textTransform: "uppercase",
            }}>Coaches Clinic — $300</button>
          </div>
        </div>
      </Section>
    </>
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 32, marginBottom: 40 }}>
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
          {["About", "Services", "Membership", "Camps", "Free Resources", "Accessibility", "Book Now"].map(item => (
      ...
      <Section bg="#0A0E1A">
        <div style={{ textAlign: "center", padding: "60px 40px", background: "linear-gradient(135deg, rgba(212,168,67,0.08), rgba(212,168,67,0.02))", border: "1px solid rgba(212,168,67,0.15)", borderRadius: 12 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <button onClick={() => setPage("Membership")} style={{ background: "transparent", border: "1px solid rgba(212,168,67,0.4)", padding: "14px 36px", color: "#D4A843", fontFamily: "'Oswald', sans-serif", fontSize: 15, fontWeight: 400, letterSpacing: 2, cursor: "pointer", borderRadius: 4, textTransform: "uppercase" }}>View Plans</button>
          </div>
        </div>
      </Section>
    </>
