            ...
            <div style={{ display:"flex", flexDirection:"column", gap:20, marginBottom:28 }}>
              ...
              <div>
                ...
                <select value={form.type} onChange={e => setForm(p=>({...p,type:e.target.value}))} style={fieldSelect}>
                  <option value="1-on-1">1-on-1 Private ($90 single / $75 recurring · 3-mo min)</option>
                  <option value="Small Group (2-4)">Small Group 2-4 ($35–$50 per player)</option>
                  <option value="Large Group">Large Group ($20–$25 per player)</option>
                </select>
              </div>
              <div>
