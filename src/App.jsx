    ...
    <Section bg="#0A0E1A">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 40, maxWidth: 800, margin: "0 auto" }}>
        <div style={{ ...cardStyle, padding: 40 }}>
          <p style={{ ...bodyFont, fontSize: 16, color: "#C8CCD8", lineHeight: 1.9, margin: "0 0 20px" }}>Chris Starr didn't take the traditional path to coaching — and that's exactly what makes him different. After obtaining an MBA and Master's in Management Information Technology, he left a corporate consulting career to pursue the work that actually mattered: developing young people through basketball.</p>
...
const BookNowPage = () => {
  return (
    <>
      <div style={{ paddingTop: 80 }} />
      <Section bg="#0A0E1A">
        <SectionTitle pre="Get Started" title="BOOK NOW" sub="Pick a day and time that works for you" />

        <div style={{ maxWidth: 560, margin: "0 auto" }}>

          {/* Main booking CTA — Google Form */}
          <a href="https://forms.gle/jNJCrdBYnpt5jAvK9" target="_blank" rel="noopener noreferrer" style={{
            display: "block", textDecoration: "none", padding: "28px 24px", borderRadius: 16, cursor: "pointer",
            background: "linear-gradient(135deg, rgba(212,168,67,0.12), rgba(212,168,67,0.04))",
            border: "2px solid rgba(212,168,67,0.3)", textAlign: "center", marginBottom: 24,
          }}>
            <div style={{ fontSize: 40, marginBottom: 12 }}>🏀</div>
            <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 22, color: "#F0D78C", letterSpacing: 2, marginBottom: 8 }}>BOOK A SESSION</div>
            <div style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 15, color: "#8A8FA3", lineHeight: 1.6 }}>
              Fill out a quick form and Coach Starr will reach out within 24 hours to confirm your session.
            </div>
            <div style={{
              display: "inline-block", marginTop: 20, padding: "16px 40px", borderRadius: 10,
              background: "linear-gradient(135deg, #D4A843, #B8902F)", color: "#0A0E1A",
              fontFamily: "'Oswald', sans-serif", fontSize: 18, fontWeight: 700, letterSpacing: 2,
            }}>OPEN BOOKING FORM</div>
          </a>
          ...
          <div style={{ ...cardStyle, padding: 24, textAlign: "center", marginBottom: 24 }}>
            ...
            <a href="mailto:chris@5starrdevelopment.com" style={{ fontFamily: "'Oswald', sans-serif", fontSize: 16, color: "#D4A843", letterSpacing: 1.5, textDecoration: "none" }}>CHRIS@5STARRDEVELOPMENT.COM</a>
          </div>

          {/* Waiver + Scholarship */}
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <a href="https://forms.gle/P1Vjfx9YFzi94Avq7" target="_blank" rel="noopener noreferrer" style={{
              display: "flex", alignItems: "center", gap: 12, padding: "18px 20px", borderRadius: 12,
              background: "rgba(255,255,255,0.02)", border: "1px solid rgba(212,168,67,0.1)", textDecoration: "none",
            }}>
              <span style={{ fontSize: 28 }}>📋</span>
              <div>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 15, color: "#F0D78C", letterSpacing: 1.5 }}>LIABILITY WAIVER</div>
                <div style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 13, color: "#5A5F73", marginTop: 2 }}>Required before your first session</div>
              </div>
            </a>
            <a href="https://forms.gle/nLuSVgTBZT3cWp9Z9" target="_blank" rel="noopener noreferrer" style={{
              display: "flex", alignItems: "center", gap: 12, padding: "18px 20px", borderRadius: 12,
              ...
              <span style={{ fontSize: 28 }}>🌟</span>
              <div>
                <div style={{ fontFamily: "'Oswald', sans-serif", fontSize: 15, color: "#F0D78C", letterSpacing: 1.5 }}>SCHOLARSHIP APPLICATION</div>
                <div style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 13, color: "#5A5F73", marginTop: 2 }}>Financial assistance available</div>
              </div>
            </a>
          </div>
