  ...
  const forms = [
    {
      ...
      desc: "Interested in training, Courtside Analytics, or just want more information? Fill out this form and Coach Starr will reach out within 24 hours.",
      url: "https://forms.gle/jNJCrdBYnpt5jAvK9",
      cta: "Open Booking Form",
    },
    {
      icon: "🌟",
      title: "SCHOLARSHIP APPLICATION",
      desc: "If financial circumstances are a barrier, this application is for you. All applications are reviewed by Coach Starr personally and kept confidential.",
      url: "https://forms.gle/nLuSVgTBZT3cWp9Z9",
      cta: "Apply for Scholarship",
    },
    {
      icon: "📋",
      title: "LIABILITY WAIVER",
      desc: "Required before your first session. Complete this waiver and photo/video consent form so we can get to work.",
      url: "https://forms.gle/P1Vjfx9YFzi94Avq7",
      cta: "Complete Waiver",
    },
  ];
  ...
  return (
    <>
      ...
      <Section bg="#0A0E1A">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24, maxWidth: 900, margin: "0 auto 48px" }}>
          {forms.map((f, i) => (
            <div key={i} style={{ ...cardStyle, padding: 32, textAlign: "center", display: "flex", flexDirection: "column" }}>
              ...
              <a href={f.url} target="_blank" rel="noopener noreferrer" style={{
                display: "block", background: "linear-gradient(135deg, #D4A843, #B8902F)", border: "none",
                padding: "14px 24px", color: "#0A0E1A", fontFamily: "'Oswald', sans-serif",
                fontSize: 13, fontWeight: 600, letterSpacing: 2, cursor: "pointer", borderRadius: 4,
        ...
        <div style={{ textAlign: "center", maxWidth: 500, margin: "0 auto" }}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 18, color: "#8A8FA3", fontStyle: "italic", marginBottom: 8 }}>
            Prefer to reach out directly?
          </p>
          <a href="mailto:chris@5starrdevelopment.com" style={{ fontFamily: "'Oswald', sans-serif", fontSize: 14, color: "#D4A843", letterSpacing: 2, textDecoration: "none" }}>
            CHRIS@5STARRDEVELOPMENT.COM
          </a>
        </div>
      </Section>
    </>
